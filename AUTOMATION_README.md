...
- **email**: Email portal (akan replace "seputarberita33@gmail.com")
- **socialHandle**: Handle social media (akan replace "seputarberita")
- **colors**: Tema warna
...
| `seputarberita` | `siteName` (tanpa spaces) |
| `seputarberita` | `socialHandle` |
| `seputarberita33@gmail.com` | `email` |
